...
TemplateRenderer.prototype.getPreloadFiles = function getPreloadFiles(context) {
    ...
    this.preloadFiles = (this.clientManifest.initial[context.entryName] || [])
        .map(normalizeFile)
    ...
    return function createBundleRenderer(
        ...
        return {
            renderToString: function(context, cb) {
                ...
                function getEntry(name, entry) {
                    if (typeof entry == "string") return entry
                    if (typeof entry == "object") {
                        name = name || Object.keys(entry)[0]
                        return entry[name]
                    }
                }

                run(context, getEntry(context.entryName, entry)).catch(function(err) {
